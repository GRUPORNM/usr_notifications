		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#usrnotifications-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"usrnotifications-display": {
								"semanticObject": "usrnotifications",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=usrnotifications",
									"url": sap.ui.require.toUrl("usrnotifications")
								}
							}
						}
					}
