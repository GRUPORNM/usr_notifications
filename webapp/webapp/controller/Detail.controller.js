sap.ui.define([
	...
	return BaseController.extend("usrnotifications.controller.Detail", {
		...
		onDeleteNotif: function () {
			...
			var sPath = this.getModel("mainDetail").getProperty("/sPath");
		...
		onMarkRead: function () {
			...
			var sPath = this.getModel("mainDetail").getProperty("/sPath");
			var oReaded = oDetailModel.getProperty("/readed");
			var oModel = this.getModel();
			var oEntry = {};
			...
			oModel.update(sPath, oEntry, {
				success: function (oResponse) {
					...
					var sMarkReadText = oResourceBundle.getText("MarkRead");
					var sMarkUnreadText = oResourceBundle.getText("markUnread");

					var oButton = that.byId("btMarkRead");
		...
		onNavToApplication: function () {
			...
			var sPath = oModel.getProperty("/target_path");
			var sAppId = oModel.getProperty("/target_app");
